        ...
        <v-card class="pa-2 justify-center">
            ...
            <v-form ref="form" @submit.prevent="submit" class="elevation-5 rounded-lg px-5 py-7">
                ...
                <v-row>
                    ...
                    <v-col>
                        <v-text-field dense outlined id="paterno" label="Apellido Paterno" type="text"
                            v-model="$page.props.user.ap_paterno"
                ...
                <v-row>
                    ...
                    -->
                    <v-text-field dense outlined v-model="form.cargo" :rules="[v => !!v || 'Se requiere el Cargo']" filled
                        label="Asigne un cargo" class="mb-n4 pa-0" required prepend-inner-icon="mdi-clipboard-account">
                    </v-text-field>
                </v-row>
                <v-row>
                    <v-col>
                ...
                <v-row>
                    ...
                    <v-col>
                        ...
                        <v-btn class="ml-4" color="primary" :class="{ 'opacity-25': form.processing }"
                            :disabled="form.processing" @click="change_password">
                            Cambiar Contraseña
                        </v-btn>
                    </v-col>
                </v-row>
...
import cambio from '@/Pages/Personal/Cambiar_password'
...
export default {
    ...
    methods: {
        ...
        async change_password() {
            ...
            this.$alert('hoas').then(res => this.$inform("Cambiar contraseña!"));
            */
        },
        alert(text) {
